...
function App() {
  ...
  const openFile = (path: string) => {
    // For browser version, just copy path or show info
    copyToClipboard(path, { stopPropagation: () => {} } as React.MouseEvent);
    alert(`File path copied to clipboard:\n${path}\n\nNote: Direct file opening is not available in browser mode.`);
  };
